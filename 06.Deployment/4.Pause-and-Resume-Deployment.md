...
kubectl set image deployment/my-first-deployment nginx=promo286/custom-nginx:4.0 --record=true
...
kubectl set resources deployment/my-first-deployment -c=nginx --limits=cpu=20m,memory=30Mi
```
### Resume Deployment 
```
