...
kubectl expose rs <ReplicaSet-Name>  --type=NodePort --port=80 ---name=<Service-Name-To-Be-Created>
kubectl expose rs my-helloworld-rs  --type=NodePort --port=80 --name=my-helloworld-rs-service
